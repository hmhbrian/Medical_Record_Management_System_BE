...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ApiResponse<?>> handleInternalAccessDenied(
                ...
                // Chứ không phải lỗi 403 bị chặn ở Filter Layer (đã được
                // CustomAccessDeniedHandler xử lý)

                ApiResponse<?> errorResponse = new ApiResponse<>(
                                false,
                                ex.getMessage() != null ? ex.getMessage() : "Truy cập bị từ chối.", // Lấy thông báo
                                                                                                    // "Unauthorized"
                                null);
